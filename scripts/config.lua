...
return {
    ...
    challenges = Challenges.process{
        ...
        {
            { caption = 'Rock Power', tooltip = 'Connect power to 20 rocks.', icon = icon('entity/big-rock', 20), condition = { type = 'custom', name = 'rock_power', data = { count = 20 } } },
            { caption = 'Total Rock Power', tooltip = 'Connect power to 100 rocks.', icon = icon('entity/huge-rock', 100), condition = { type = 'custom', name = 'rock_power', data = { count = 100 } } },
        },
        ...
        Challenges.factory('laser-turret', { 50, 250 }),
        Challenges.factory('fast-inserter', { 250, 1000 }),
        Challenges.factory('rail', { 500, 2500, 5000 }),
        Challenges.factory('big-electric-pole', { 50, 250, 500 }),
        Challenges.factory('train-stop', { 50, 250, 500 } ),
        Challenges.factory('car', { 10, 50, 250 } ),
        Challenges.factory('refined-hazard-concrete', { 1000, 2500, 5000 } ),
        Challenges.factory( -- TODO: custom icon
        ...
        Challenges.factory('flamethrower-turret', { 25, 100 } ),
        Challenges.factory('rocket', { 500, 2500 } ),
        Challenges.factory('land-mine', { 1000, 5000 } ),
        Challenges.factory('flamethrower-ammo', { 500, 2500 } ),
        Challenges.factory('grenade', { 50, 250, 1000 } ),
        Challenges.factory('defender-capsule', { 10, 50, 250 } ),
        Challenges.factory('submachine-gun', { 100, 250 } ),
        Challenges.factory('programmable-speaker', { 250, 1000 } ),
        Challenges.factory('fast-splitter', { 100, 250 } ),
        Challenges.factory('pump', { 250, 1000 } ),
        Challenges.factory('electric-engine-unit', { 250, 1000 } ),
        Challenges.factory('oil-refinery', { 50, 200 } ),
        Challenges.factory('solid-fuel', { 500, 2000, 10000 } ),
        Challenges.factory('heavy-armor', { 5, 10 } ),
