...
return {
    ...
    challenges = Challenges.process{
        ...
        -- Craft
        { caption = 'Uranium Touch', condition = { type = 'craft', name = 'uranium-235' } },
        { caption = 'Blue Chips', condition = { type = 'craft', name = 'processing-unit', count = 200 } },
        { caption = 'LDS Factory', condition = { type = 'craft', name = 'low-density-structure', count = 200 } },
        { caption = 'Rocket Fuel', condition = { type = 'craft', name = 'rocket-fuel', count = 100 } },
        { caption = 'Shotgun Lord', condition = { type = 'craft', name = 'shotgun', count = 50 } },
        { caption = 'Red Supremacy', condition = { type = 'craft', name = 'fast-underground-belt', count = 200 } },
        { caption = 'Bulk Inserters',condition = { type = 'craft', name = 'bulk-inserter', count = 200 } },
        { caption = 'Paint It Red', condition = { type = 'craft', name = 'copper-ore', count = 10000 } },
        {
            Challenges.factory('Underground Pipe', 'pipe-to-ground', { 500, 2000 }),
            Challenges.factory('Fast Inserter', 'fast-inserter', { 250, 1000 }),
            Challenges.factory('Rail', 'rail', { 500, 2500, 5000 }),
            Challenges.factory('Big Electric Pole', 'big-electric-pole', { 50, 250, 500 }),
            Challenges.factory('Train Stop', 'train-stop', { 50, 250, 500 } ),
            Challenges.factory('Car', 'car', { 10, 50, 250 } ),
            Challenges.factory('Refined Hazard Concrete', 'refined-hazard-concrete', { 1000, 2500, 5000 } ),
            Challenges.factory('Accumulator', 'accumulator', { 500, 1000 } ),
            Challenges.factory('Module',
            ...
            Challenges.factory('Flamethrower Turret', 'flamethrower-turret', { 25, 100 } ),
            Challenges.factory('Rocket', 'rocket', { 500, 2500 } ),
            Challenges.factory('Land Mine', 'land-mine', { 1000, 5000 } ),
            Challenges.factory('Flamethrower Ammo', 'flamethrower-ammo', { 500, 2500 } ),
            Challenges.factory('Grenade', 'grenade', { 50, 250, 1000 } ),
            Challenges.factory('Defender Capsule', 'defender-capsule', { 10, 50, 250 } ),
            Challenges.factory('Submachine Gun', 'submachine-gun', { 100, 250 } ),
            Challenges.factory('Programmable Speaker', 'programmable-speaker', { 250, 1000 } ),
            Challenges.factory('Fast Splitter', 'fast-splitter', { 100, 250 } ),
            Challenges.factory('Electric Pump', 'pump', { 250, 1000 } ),
            Challenges.factory('Oil Refinery', 'oil-refinery', { 50, 200 } ),
            Challenges.factory('Solid Fuel', 'solid-fuel', { 500, 2000, 10000 } ),
        },
